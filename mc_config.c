...
PID_Handle_t PIDSpeedHandle_M1 =
{
  ...
  .wLowerIntegralLimit = -(int32_t)PERIODMAX * (int32_t)SP_KIDIV,
  .hUpperOutputLimit       = (int16_t)PERIODMAX,
  .hLowerOutputLimit       = -(int16_t)PERIODMAX,
...
Bemf_ADC_Handle_t Bemf_ADC_M1 =
{
  ...
  .Reliability_hysteresys             =	SL_ADC_MEAS_ERRORS_BEFORE_FAULTS,
...
Bemf_ADC_Handle_t *pBemf_ADC_M1 = &Bemf_ADC_M1;

Bemf_Handle_t Bemf_M1 =
{
  ._Super                        = (SpeednPosFdbk_Handle_t*)&Bemf_ADC_M1,
  .pFctForceConvergency1         = NULL,
  .pFctForceConvergency2         = NULL,
  .pFctBemfOtfResetPLL            = NULL,
  .pFctBemf_SpeedReliabilityCheck = NULL
};
